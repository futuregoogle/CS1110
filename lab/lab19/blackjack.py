...
class Blackjack():
    ...
    Instance Attributes:
        ...
        deck [list of Cards]: list of the remaining Cards to draw from.
            The deck is assumed to hold enough Cards that it won't run out.
    """
    ...
    def __init__(self,d):
        ...
        The player's hand will be the first two cards in d.
        The dealer's hand will be the third card in d.
    ...
    def __str__(self):
        ...
        """
        player = str(self.playerScore())
        dealer = str(self.dealerScore())
        return "player:" + " " + player + ";"
        pass  # STUDENTS: REPLACE WITH YOUR IMPLEMENTATION.
              # But you will need to have implemented other methods first;
              # see the lab handout for instructions.
              # The returned string must have punctuation and spacing exactly
